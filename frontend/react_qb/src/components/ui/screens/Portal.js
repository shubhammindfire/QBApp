            ...
            <div className="md:ml-64 mt-16 py-4 text-3xl text-center bg-blueGray-100">
                ...
                <div className="text-base mx-3">
                    <p className="mt-2 lg:mx-52">
                        ...
                        and marketed by Intuit. QuickBooks products are geared
                        mainly toward small and medium-sized businesses and
                        offer on-premises accounting applications.
                    </p>
                    <div className="m-3 lg:mx-72 text-left">
                        <p>
                            This application integrates with QuickBooks and
                        ...
                        <ul className="ml-4">
                            ...
                            <li className="list-disc">View their Customers</li>
                            <li className="list-disc">View their Items</li>
                            <li className="list-disc">
                                View, Create, Edit and Delete their Invoices
                            </li>
                        </ul>
                    </div>
                    <p className="m-3">
                        All the data and the changes made to them are in sync
                        the QuickBooks Online(QBO) platform
                    </p>
